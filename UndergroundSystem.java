...
public class UndergroundSystem {
    ...
    static Map<String, List<int []>> cin;
    ...
    public double getAverageTime(String startStation, String endStation) {
        ...
        // if (sum < 0) // some where overflowed or 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("cin.size(): " + cin.size());
        for (Map.Entry<String, List<int []>> entry : cin.entrySet()) {
            System.out.print(entry.getKey() + ": "); 
            for (int z = 0; z < entry.getValue().size(); z++) 
                System.out.println("Arrays.toString(entry.getValue().get(z)): " + Arrays.toString(entry.getValue().get(z)));
                System.out.print("\n");
        }
        System.out.println("cout.size(): " + cout.size());
        for (Map.Entry<String, List<int []>> entry : cout.entrySet()) {
            System.out.print(entry.getKey() + ": "); 
            for (int z = 0; z < entry.getValue().size(); z++) 
                System.out.println("Arrays.toString(entry.getValue().get(z)): " + Arrays.toString(entry.getValue().get(z)));
            System.out.print("\n");
