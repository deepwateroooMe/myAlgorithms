...
//         }
        ...
        //             else if (val == 1) mouseWin = true;
        //         }
        //         return f[i][j][k] = (mouseWin ? 1 : 0);
        //     }
        // }
        // // int [][] a = new int [][] {{2,5},{3},{0,4,5},{1,4,5},{2,3},{0,2,3}};
