...
//         }
        ...
        //     return i;
        // }
        // private List<String> parseOneChunk(String s) { // { , , } or {c, d}{a, b} or {ab{}, b}
        ...
        //         if (s.charAt(i) == '{') {
        //             j = getMatchedRIdx(s, i);
        //             List<String> tmp = parseOneChunk(s.substring(i+1, j));
        //             // List<String> tmp = braceExpansionII(s.substring(i, j+1));
        //             if (j == n-1 && ss.size() == 0) return tmp;
        //             ss.addAll(tmp);
        //             if (j == n-1) return new ArrayList<String>(ss);
        //             i = j+2;
        ...
        //                 List<String> r = parseOneChunk(s.substring(j+1, k));
        //                 List<String> tls = new ArrayList<>();
        //                 for (String v : r) 
        //                     tls.add(tmp + v);
        //                 // System.out.println(" (k <= n-1 && s.charAt(k+1) == ','): " +  (k <= n-1 && s.charAt(k+1) == ','));
        //                 if (k <= n-1 && s.charAt(k+1) == ',') {
        //                     ss.addAll(tls);
        //                     // for (String v : r) {
        //                     //     // System.out.println("(tmp + v): " + (tmp + v));
        //                     //     ss.add(tmp + v);
        //                     // }
        //                     if (k == n-1) return new ArrayList<String>(ss);
        //                 } else if (Character.isLetter(s.charAt(k+1))) {
        //                     int x = k+1;
        //                     while (x < n && 这里再想一下
        //                 }
        //                 //  这里可能还有特殊情况 : a{fkjldfkj{}}bc
        //                 i = k+2;
        //             }
        //         } // else if (s.charAt(i) == ',') {
        //           //   j = i+1;  // ,abcd
        ...
        //           //   if (s.charAt(j) == ',') {
        //           //       List<String> l = parseOneChunk(s.substring(i+1, j));
        //           //       ss.addAll(l);
        //           //       if (j == n-1) return new ArrayList<String>(ss);
        //           //       i = j;  
        //           //   } 
        ...
        //             if (j == n-1) return parseOneChunk(s.substring(i+1, j)); // { , , }
        //             List<String> left = parseOneChunk(s.substring(i+1, j));  // {}{}  or {}{{}{}} etc
        //             List<String> right = parseOneChunk(s.substring(j+1));
        //             List<String> res = new ArrayList<>();
        //             for ( i = 0; i < left.size(); i++) 
        //                 for ( j = 0; j < right.size(); j++) 
        //                     res.add(left.get(i) + right.get(j));
        //             return res;
        //         }
