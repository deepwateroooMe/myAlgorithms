...
\label{sec-1-1}
\begin{itemize}
\item When thought about sth, cannot fall asleep, fass asleep at 8:00am, and waked up at 12:00, so today would be filled with tidious things;
\item The haircurt store was closed during Christmas, and opened today, so spent \$8 and half an hour in store got my hair cut, but still spent 1 hours at home to redo it to thin the hair layers; Cut hair has nothing to do with love life, but rather that I don't want to waste time on the hair at this semster;
