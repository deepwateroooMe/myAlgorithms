...
\label{sec-1-2}
\begin{itemize}
\item a matter: get rid of it as soon as possible, 7-12,
...
\label{sec-3-2}
\begin{itemize}
\item wrote quite a few yasnippets for java quite great\textasciitilde{}!
\end{itemize}
...
\label{sec-6-1}
\begin{itemize}
\item Permutation: Arrays.asList() not working in 1.6, spent hours here, figured should be too old openjde-1.6
\item retate Image
\end{itemize}
...
\label{sec-10-1}
\begin{itemize}
\item Go to court on 1/14/2015, Wednesday 8:30am
\end{itemize}
