...
\section{4/25/2015, Saturday, May-Summer Section 2015 Study Plan}
\label{sec-1}
\begin{itemize}
\item \textbf{Algorithms \& Software Engineering Education}:
\begin{itemize}
\item I took \textbf{cs502 Algorithms} and \textbf{cs502 Software Engineering} directed background study 2 credits each course from a famous professor from the department in Spring 2013. The courses are P/F, and we study by meeting the intructor once each week for 40 minutes for raising questions if we have any (2 students only, the other one was a Ph.D Candidate from Math Department without any programming experience). At the same time, I audit cs395 python-based \textbf{Analysis of Algorithms} course in this Spring 2013 semester with superficial/super-easy mid-term final 2 exams and without homeworks.
\item It has been barely any learning experience for these two courses, and that was one main reason I registered \textbf{CS480 Senior Design} course in Fall 2014.
\item Good or bad, reasonable or not, those are the education I got from the university\ldots{}.
\item So, I have always been paying careful attention to my Algorithms and Software Engineering practises.
\end{itemize}
\item The Algorithms parts I have finished: 
\begin{itemize}
\item \textbf{ctci:} Cracking the Coding Interview, practised a basic c++ version during winter break 2013;
\begin{itemize}
\item Don't know \textbf{Emacs org-mode} yet at that time, purely latex-based src files.
\item I included all the src files in case somebody else would want to make his own personal modifications.
\end{itemize}
\item \textbf{LeetCode:} \url{https://leetcode.com/problemset/algorithms/} (lc)
\begin{itemize}
\item between 3/25/2014 and 4/30/2014, finished slightly easier about 100 problems using \textbf{c++}, finished about the rest 50 during followed summer using c++;
\item During winter break 2014, finished about 150 problems using \textbf{Java} for the second round for lc; \textbf{Up to this point, feels comfortable using Java programming language;}
\end{itemize}
\item \textbf{LintCode:} \url{http://www.lintcode.com/en/problem/}
\begin{itemize}
\item During winter break 2014, finished about 50 problems using \textbf{Java}, about 130 problems left undone yet; \textbf{Up to this point, feels comfortable using Java programming language;}
\end{itemize}
\item < \textbf{Nine Chapter Algorithms} >: It's an online learning Camp my friends and I have attented during late Summer 2014. The course instructor is a genius and explains the theories especially easy to understand.
\item Others include \textbf{Mitbbs} Chinese forum \textbf{JobHunting, Java, Programming} boards, and \textbf{MeetQun} forum \url{http://meetqun.com/} and online judges as well, and the famous "¶Î·Ö×Ó"ÅàÑµ°à in Chinese community.
\end{itemize}
\item The Algorithms parts I plan to work on during May-Summer section 2015: 
\begin{itemize}
\item \textbf{Finish the rest about 130 algorithms problems in LintCode using Java}; LeetCode is a great coding set as well, but after c++ \& Java two rounds of coding, feels like I could recite the answers by bad studing habits (I should at least understand each problems and algorithms instead); So a round using Java for LintCode could help refresh my mind, and LintCode coding set does inspire further potential critical thinking for me; Expect to understand the algorithms pretty well when finish;
\item \textbf{Coding LeetCode a third round using Python programming language} for Python programming propose only. I have coding experience using Python for only one month during 2013 Internship season for three small projects [a log module insertion within SSD MSTK test Suite by parsing original software/driver generated log files (8 to 11 python module files), an independent VDBench test suite development for STEL Automation Python Framework), and a complete full-functional GUI project for Medusa excel data statistical plots]. Expect this round Python coding ends my "EASY" algorithms journey, and understand Python language to a slightly deeper layer;
\item \textbf{EPI: Elements of Programming Interviews}, start "MEDIUM" or "HARD" algorithms study process from this book. Practise like ctci, LeetCode, LintCode\ldots{}.
\item \textbf{Study Java Spring framework, build a Java-based dynamic personal blog for fun} and to practise project handling abilities.
\item \textbf{Study and review OOP, Operating System questions, design patterns for interview.}
\item Solve all the \textbf{bug} I have in algorithms before. It was the solving process that helps.
\item Temporatorily won't work on \textbf{Sum\textunderscore JobHunting.org} for the first months or so, but will focus on updating it when finish Python LeetCode round.
\item Form a habit to \textbf{solve 3-5 algorithms problems each day} for programming and algorithms practise propose only.
\end{itemize}
\end{itemize}

\section{2/22/2015, Sunday}
\label{sec-2}
\begin{itemize}
\item Whether I like it or not, I am into the midiUI project now, and will have to try my best to make it work. It is challenging, but I have to work on it.
\item Many things to do recently, but try my best to make everything work out as expected.
\item fall asleep late last night, too tired today, waked up at 8:47, went to work without washing cleaning\ldots{}
\item work on midiUI tomorrow, spend couple of hours to write for gs update, hope will make some progress on midiUI tomorrow; ever since Saturday night, I began to realize how much work/efford I need to make to make this midiUI GUI responsive, so far my main UI still got blocked, and I could only play and stop for one key, afterwards will get blocked, well dive into it\ldots{}
\item work on JH problems after midiUI if midiUI done if recently possible
\end{itemize}
\section{2/11/2015, Wednesday}
\label{sec-3}
\begin{itemize}
\item Reverse Nodes in k-Group recursion bug !\textasciitilde{}~\textasciitilde{}~\textasciitilde{}~\textasciitilde{}~
\item live dead recently, woke up by another rommoate's drying cloth at
6:00am, that morning ended up to be 12:00am - 12:00pm 12 hours
continuous sleep on Sunday\ldots{}
\item 12:00 pm - 12:00 am for the followed two days, 2:00 - 12:00 last
night\ldots{}
\item Scheduled weekly meeting time with advisor on Wednesday
...
of only one, and meet and start from there\ldots{}
\item Strengthless in mind recently, severe and tough\ldots{}.
\item waiting for Wednesday, made up the mind to study and search for job,
try to be environmentally more stable\ldots{}
\item Miss an old friend\ldots{}
\end{itemize}
...
\item will work in the afternoon, but will work on algorithms in the evening\ldots{}.
\end{itemize}
