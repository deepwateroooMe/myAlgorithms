...
//         }
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public int[] bestTower(int[][] f, int[] a, int d) { // 最蠢笨的暴力
        //     int n = f.length, j = -1, max = -1;
        //     int [] r = new int [2];
        //     // 【 x 轴升序； y 轴升序】
        //     Arrays.sort(f, (x, y)->(x[0] != y[0] ? x[0] - y[0] : x[1] - y[1]));
        //     for (int i = 0; i < n; i++) {
        //         if (Math.abs(f[i][0] - a[0]) + Math.abs(f[i][1] - a[1]) <= d) {
        //             if (f[i][2] > max) {
        //                 j = i;
        //                 max = f[i][2];
        //             } else if (f[i][2] == max && f[i][0] <= f[j][0] && f[i][1] < f[j][1])
        //                 j = i;
        //         }
        //     }
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public int minOperations(int[] f, int[] a) {
        //     int n = f.length, p = -1, pi = -1;
        //     Map<Integer, Integer> m = new HashMap<>(); // 【TODO：】用个 Set<Integer> s = new HashSet<>(); 就可以了，不必用字典
        //     for (int i = 0; i < n; i++) {
        //         if (f[i] == a[i] || p == f[i]) continue;
        //         p = f[i];
        //         pi = i;
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 一看就是【动规】；可是亲爱的表哥的活宝妹，亲爱的表哥的活宝妹、笨宝妹写不到这个题目的动规，就只能先写【记忆化深搜】了。。
        // static final int mod = (int)1e9 + 7;
        // public int alternatingXOR(int[] a, int x, int y) { // TLE TLE TLE 927/1032 passed 
        //     n = a.length; this.x = x; this.y = y; this.a = a; 
        //     g = new int [n]; g[0] = a[0];
        //     for (int i = 1; i < n; i++)
        //         g[i] = (g[i-1] ^ a[i]);
        //     System.out.println(Arrays.toString(g));
        //     f = new Integer [n][2];
        //     return (dfs(n-1, x) + dfs(n-1, y)) % mod;
        // }
        // Integer [][] f; // 记忆数组
        // int [] g, a; // 【前缀 XOR 异或值】
        // int n, x, y;
        // int dfs(int i, int k) {
        //     if (i == 0) return (g[i] == k && k == x ? 1 : 0);
        //     int j = (k == x ? 0 : 1);
        //     if (f[i][j] != null) return f[i][j];
        //     long ans = (g[i] == k && k == x ? 1 : 0); // 必须用 x 打头
        //     for (int o = i-1; o >= 0; o--) {
        //         //if (o < i && a[o] == a[o+1]) continue; // 【写错了】：这么写，结果不对。。
        //         if ((g[i] ^ g[o]) == k)
        //             ans = (ans + dfs(o, k == x ? y : x)) % mod;
        //     }
        //     return f[i][j] = (int)ans;
        // }

        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public List<Integer> minimumFlips(int n, int[][] egs, String S, String T) {
        //     g = new ArrayList [n];
        //     Arrays.setAll(g, z -> new ArrayList<>());
        //     for (int i = 0; i < egs.length; i++) {
        //         int u = egs[i][0], v = egs[i][1];
        //         g[u].add(new int [] {v, i});
        //         g[v].add(new int [] {u, i});
        //     }
        //     s = S.toCharArray(); t = T.toCharArray();
        //     // 假定：【0 为树的根节点】DFS 遍历树
        //     // 亲爱的表哥的活宝妹，不知道这个破烂题目，要怎么去想。。。读不懂这个破烂题目的、破烂提示
        // }
        // List<int []> [] g;
        // char [] s, t;
        // int n;
...
//         }
        ...
        //     int n = a.length, m = 0, idx = 0, j = 0;
        //     for (int v : a)
        //         if (v >= 0) m++;
        //     int [] f = new int [m];
        //     for (int i = 0; i < n; i++) {
        //         if (a[i] < 0) continue;
        //         j = (idx++ + m * (k <= m ? 1 : k / m + 1) - k) % m;
        //         f[j] = a[i];
        //     }
        //     j = 0;
        //     for (int i = 0; i < n; i++) {
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public int specialNodes(int n, int[][] egs, int x, int y, int z) {
        //     this.n = n;
        //     g = new ArrayList [n];
        //     Arrays.setAll(g, w -> new ArrayList<>());
        //     for (int [] e : egs) {
        //         int u = e[0], v = e[1];
        //         g[u].add(v);
        //         g[v].add(u);
        //     }
        //     f = new int [n]; ff = new int [n]; fff = new int [n];
        //     dfs(x, -1, f);
        //     dfs(y, -1, ff);
        //     dfs(z, -1, fff);
        //     int [] a = new int [3];
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 思路： k 个 '1' 重复，后续添加 0
        // // 【添加：第 1 个 0】多产生 k 个最小数
        // // 【添加：第 2 个 0】多产生 k + (k-1) 个最小数
        // // 【添加：第 3 个 0】多产生 k + 2*(k-1) 个最小数
        // // 。。。
        // // 【添加：第 j 个 0】多产生 k + (j-1)*(k-1) 个最小数
        // // 【TODO：】感觉，这个结果，是可以数数算出来的。。。可是，亲爱的表哥的活宝妹，亲爱的表哥的活宝妹、笨宝妹，不喜欢这个破烂题目，不想再写这个破烂题目了
        // public long nthSmallest(long n, int k) {
        //     StringBuilder s = new StringBuilder("1".repeat(k));
        //     if (n == 1) return Long.parseLong(s.toString());
        //     if (k == 1) {
        //         for (int i = 0; i < n-1; i++) 
        //             s.append('0');
        ...
        //     }
        //     int f = 1;
        //     // 遍历：添加 i 个 0, “1000...(i-1)0111..(k-1)1”
        ...
        //             continue;
        //         }
        //         // 遍历：【自右往左】第 j 个0: 向右向尾巴、移动 k-1 个 '1' 位的情况
        //         for (int j = 0; j <= i-1; j++) {
        //             if (n <= f + (j == 0 ? k : k-1)) {
        //                 if (j == 0) {
        //                     // s.insert(n-f, '0'); // 剩余的、前面的 i-(j+1) 个0 不动 ==> 1000...(i-[j+1])01011...(k-2)1
        //                 } else {
        //                     s.insert(1, "0".repeat(i-(j+1))); // 剩余的、前面的 i-(j+1) 个0 不动 ==> 1000...(i-[j+1])01011...(k-2)1
        //                     // 【TODO：】                            
        //                 }
        //                 return "";
        //             }
        ...
        //         f = f + (1 << i);
        //     return s.length() + (n == f ? 1 : 0);
        // }

        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 这个破烂题目，死难死难的，晚点儿再写这个
        // public int finalElement(int[] nums) {
        // }

        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // int riderIdx, driverIdx;
        // Map<Integer, Integer> m;
        // TreeMap<Integer, Integer> tr, dr;
        // public RideSharingSystem() {
        //     riderIdx = 0; driverIdx = 0; 
        //     m = new HashMap<>();
        //     tr = new TreeMap<Integer, Integer>(Map.Entry.comparingByValue());
        //     dr = new TreeMap<Integer, Integer>(Map.Entry.comparingByValue());
        // }
        // public void addRider(int riderId) {
        //     if (tr.containsKey(riderId))
        //         tr.remove(riderId);
        //     tr.put(riderId, riderIdx++);
        // }
        // public void addDriver(int driverId) {
        //     if (dr.containsKey(driverId))
        //         dr.remove(driverId);
        //     dr.put(driverId, driverIdx++);
        // }
        // public int[] matchDriverWithRider() {
        //     if (tr.size() > 0 && dr.size() > 0) {
        //         int i = tr.firstEntry().getKey(), j = dr.firstEntry.getKey();
        //         m.put(i, j);
        //         tr.remove(i);
        //         dr.remove(j);
        //     }
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 亲爱的表哥的活宝妹，亲爱的表哥的活宝妹、笨宝妹，觉得这伸【动规】狠好写才对，为什么会难？？？
        // // TLE TLE TLE 993/1027 passed .... 就知道，没写四维，用三维字典后，会超时。。。【TODO：】不用三维字典，用四给数组，解决掉超时的问题
        // // [0/1]: 不删除与删除；【0/1】升序、【TODO：】三维不够用，要用四维。。。
        // public int longestAlternating(int[] g) {
        //     int n = g.length, max = 1;
        //     // [0/1]: 不删除与删除；【0/1】升序、【TODO：】三维不够用，要用四维。。。
        //     // int [][][] f = new int [n][2][2];
        //     Map<Integer, Integer> [][][] f = new HashMap [n][2][2]; // 字典可以改为【四维数组】来解决。。写法更简单
        //     // for (int i = 0; i < n; i++)
        //     //     for (int j = 0; j < 2; j++) 
        //     //     Arrays.fill(f[i][j], 1);
        //     for (int i = 0; i < n; i++)
        //         for (int j = 0; j < 2; j++) 
        //             for (int k = 0; k < 2; k++) {
        //                 f[i][j][k] = new HashMap<Integer, Integer>(); 
        //                 f[i][j][k].put(i, 1);
        //             }
        //     // 遍历：每个数
        //     for (int i = 1; i < n; i++) {
        //         if (g[i] > g[i-1]) { // 【升序】
        //             f[i][0][0].put(i, f[i-1][0][1].get(i-1) + 1);
        //             // 删除：【当前下标 i】
        //             for (int j = 0; j < 2; j++) 
        //                 f[i][1][j].put(i, f[i-1][0][j].get(i-1));
        //             // 删除：当前下标 i 之前的【0,1...i-1】之间的某个数，怎么知道删除的是哪个数，跟哪个下标比较？只需要区分，删除的是 i-1 还是 i-1 之前的数
        //             // 如果，删除的是【 i-1】，与 (i-2) 比较
        //             if (i > 1) {
        //                 if (g[i] > g[i-2]) 
        //                     f[i][1][0].put(i-1, Math.max(f[i][1][0].getOrDefault(i, 1), f[i-2][0][1].get(i-2) + 1));
        //                 else if (g[i] < g[i-2])
        //                     f[i][1][1].put(i-1, Math.max(f[i][1][1].getOrDefault(i, 1), f[i-2][0][0].get(i-2) + 1));
        //             }
        //             for (Map.Entry<Integer, Integer> en : f[i-1][1][1].entrySet()) {
        //                 int k = en.getKey(), p = en.getValue();
        //                 if (p + 1 > Collections.max(f[i][1][0].values()))
        //                     f[i][1][0].put(k, p + 1);
        //             }
        //         } else if (g[i] == g[i-1]) { // 【重复】
        //             for (int j = 0; j < 2; j++) 
        //                 f[i][1][j] = f[i-1][0][j];
        //             // 感觉：当有重复数时，自己的逻辑设定，仅只处理第 2 个重复，就不需要再考虑，删除第 1 个重复和情况
        //         } else { // g[i] < g[i-1] 【降序】
        //             f[i][0][1].put(i, f[i-1][0][0].get(i-1) + 1);
        //             for (int j = 0; j < 2; j++) 
        //                 f[i][1][j] = f[i-1][0][j];
        //             // 删除：当前下标 i 之前的【0,1...i-1】之间的某个数，怎么知道删除的是哪个数，跟哪个下标比较？只需要区分，删除的是 i-1 还是 i-1 之前的数
        //             // 如果，删除的是【 i-1】，与 (i-2) 比较
        ...
        //                     f[i][1][1].put(i-1, Math.max(f[i][1][1].getOrDefault(i, 1), f[i-2][0][0].get(i-2) + 1));
        //             }
        //             for (Map.Entry<Integer, Integer> en : f[i-1][1][0].entrySet()) {
        //                 int k = en.getKey(), p = en.getValue();
        //                 if (p + 1 > Collections.max(f[i][1][1].values()))
        //                     f[i][1][1].put(k, p + 1);
        //             }
        //         }
        //         max = Math.max(max, Math.max(Math.max(Collections.max(f[i][0][0].values()), Collections.max(f[i][0][1].values())),
        //                                      Math.max(Collections.max(f[i][1][0].values()), Collections.max(f[i][1][1].values()))));
        //     }
        //     return max;
        // }
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 亲爱的表哥的活宝妹，亲爱的表哥的活宝妹、笨宝妹，觉得这伸【动规】狠好写才对，为什么会难？？？
        // // TLE TLE TLE 就知道，没写四维，用三维字典后，会超时。。。【TODO：】不用三维字典，用四给数组，解决掉超时的问题
        // // [0/1]: 不删除与删除；【0/1】升序、【TODO：】三维不够用，要用四维。。。
        // // 亲爱的表哥的活宝妹，亲爱的表哥的活宝妹、笨宝妹，写到这里，脑袋昏掉了，不想不再这个破烂题目了。。。
        // public int longestAlternating(int[] a) {
        //     int n = a.length, max = 1;
        //     // [0/1]: 不删除与删除；【0/1】升序、【TODO：】三维不够用，要用四维。。。
        //     int [][] f = new int [n][2]; // 不删除，区分【0: 升序；1 降序】
        //     int [][][] g = new int [n][2][2]; // 删除：区分：【0: 升序；1 降序】【0: 删除当前下标 i; 1: 0 至i-1 之间的某下标删除】
        //     for (int i = 0; i < n; i++) {
        //         Arrays.fill(f[i], 1);
        //         for (int j = 0; j < 2; j++) 
        //             Arrays.fill(g[i][j], 1);
        ...
        //             // 删除：【当前下标 i】
        //             for (int j = 0; j < 2; j++) 
        //                 g[i][j][0] = f[i-1][j]; // g[i][j][0], 用 [0] 来标记，删除的是【当前下标 i】
        //             // // 删除：当前下标 i 之前的【0,1...i-1】之间的某个数，怎么知道删除的是哪个数，跟哪个下标比较？只需要区分，删除的是 i-1 还是 i-1 之前的数
        //             // // 如果，删除的是【 i-1】，与 (i-2) 比较
        //             // if (i > 1) { // g[i][j][1], 用 [1] 来标记，删除的是【当前下标 i】之前的某下标，现在是（ i-1）
        //             //     if (a[i] > a[i-2]) 
        //             //         g[i][0][1] = Math.max(g[i][0][1], g[i-2][1][1] + 1);
        //             //     else if (a[i] < a[i-2])
        //             //         g[i][1][1] = Math.max(g[i][1][1], g[i-2][0][1] + 1);
        //             // }
        //             // for (int j = 0; j < 2; j++) 
        //             //     g[i][j][1] = Math.max(g[i][j][1], g[i-1][1-j][1]);
        //         } else if (a[i] == a[i-1]) { // 【重复】：这个分支的细节，哪里没能处理好。。。不想再写这个破烂题目了。。。
        //             for (int j = 0; j < 2; j++) {
        //                 f[i][j] = f[i-1][j];
        //                 g[i][j][0] = f[i-1][j];
        //                 // 【TODO：】重复删除的，这里忽然不知道怎么处理了。。。
        //                 // g[i][j][1] = Math.max(g[i-1][1-j][0], g[i-1][1-j][1]); // 这里需要比较来确定，结论未必成立  // <<<<<<<<<<<<<<<<<<<< 【TODO：】
        //                 // g[i][j][1] = g[i-1][1-j][1]; // 【TODO：】 if...else...else... 里共同的部分提出去了
        //                 g[i][j][1] = g[i-1][j][0]; // 【TODO：】 if...else...else... 里共同的部分提出去了
        //             }
        //             // 感觉：当有重复数时，自己的逻辑设定，仅只处理第 2 个重复，就不需要再考虑，删除第 1 个重复和情况
        //         } else { // a[i] < a[i-1] 【降序】
        //             f[i][1] = f[i-1][0] + 1;
        ...
        //         for (int j = 0; j < 2; j++) 
        //             g[i][j][1] = Math.max(g[i][j][1], g[i-1][1-j][1]);
        //         max = Math.max(max, Math.max(Arrays.stream(f[i]).max().getAsInt(),
        //                                      Math.max(Arrays.stream(g[i][0]).max().getAsInt(), Arrays.stream(g[i][1]).max().getAsInt())));
        //     }
        //     return max;
        // }
...
//         }
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public List<Integer> toggleLightBulbs(List<Integer> l) {
        //     int [] f = new int [101];
        //     for (int v : l) 
        //         f[v] = (f[v] + 1) % 2;
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public int firstUniqueFreq(int[] g) {
        //     int n = g.length, o = 100001;
        //     int [] f = new int [o];
        //     for (int v : g) 
        //         f[v]++;
        //     Map<Integer, Integer> m = new HashMap<>();
        ...
        //     int j = n;
        //     for (int i = 0; i < n; i++)
        //         if (ss.contains(g[i])) return g[i];
        //     return -1;
        // }

        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 亲爱的表哥的活宝妹，上次【子数组：最大最小差值】的题目，没能写出来，可是总感觉，应该能够写得出来，才对，。。好像也没有那么难
        // public int maxXor(int[] a, int k) {
        //     if (k == 1) return Arrays.stream(a).max().getAsInt();
        //     int n = a.length;
        //     int [] f = new int [n+1];
        //     for (int i = 1; i <= n; i++) 
        //         f[i] = (f[i-1] ^ a[i-1]);
        //     // 【自左向右】遍历数组：以（当前下标 i）作为 [最大值] 来左右延伸子数组？
        // 亲爱的表哥的活宝妹，去读那【语文是体育老师教的、破烂提示】根本就读不懂，不知道它的提示说的是什么意思
        // 感觉，与【0/1】数位 Trie 相关，就是，数组里最大值 2^15, 2 进制表示，不超过 15 位。放进二进制【0/1】数位的 trie 里，树不超过 15 层高度
        // 可是，最大值与最小值，还是不知道是怎么回事。。
        // }

        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 【字符串】类型的题目好繁，亲爱的表哥的活宝妹，亲爱的表哥的活宝妹、笨宝妹，今天不想再写了。。
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // public int almostPalindromic(String S) {
        //     int n = S.length(), max = 1; char [] s = S.toCharArray();
        //     int [][] f = new int [n][2], g = new int [n][2]; // odd even centers
        //     for (int i = 0; i < n; i++) {
        //         Arrays.fill(f[i], 1);
        //         Arrays.fill(g[i], 1);
        //     }
        //     // 遍历：填充 odd center 【左、右】扩展的最大片段长度
        //     int l = 0, r = 0, k = -2;
        ...
        //     int n = a.length, j = 1, f = 0; // j: active Player multiplier 
        //     for (int i = 0; i < n; i++) {
        //         if (a[i] % 2 == 1) 
        //             j = -1 * j;
        //         if ((i + 1) % 6 == 0)
        ...
        //         f += factorial(c-'0');
        //     int [] r = new int [10];
        //     for (char c : String.valueOf(f).toCharArray()) 
        //         r[c-'0']++;
        //     for (char c : S.toCharArray()) 
        //         r[c-'0']--;
        //     for (int i = 0; i < 10; i++) 
        ...
        //     int n = S.length(), j = 0; char [] s = S.toCharArray(), t = new char [n];
        //     int l = 0, r = 0;
        //     for (char c : T.toCharArray()) 
        //         if (c == '0') l++;
        //         else r++;
        //     for (int i = 0; i < n; i++) {
        //         if (s[i] == '0' && r > 0 || s[i] == '1' && l > 0) {
        //             t[j++] = '1';
        //             if (s[i] == '0') --r;
        //             else --l;
        //         } else {
        ...
        // // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // // 亲爱的表哥的活宝妹的【记忆化深搜：暴力解法】TLE TLE TLE 979/999-passed
        // // 这个题目的本质是：【把 k 和 [23456] 分解质因子】，把数组，拆分成 3 个子序列：一个用作分子，一个用作分母，一个可以无视
        // // 根据 [23456] 中（2/3/5）质因子的个数， k 中（2/3/5）各质因子的个数来决定：
        // // 含重复数字的数组中——需要统计数组中的词频，（选择而非排列）与【组合】的方案数。。
        // // 亲爱的表哥的活宝妹，今天上午不想再写这个破烂题目了。。。
        // public int countSequences(int[] a, long k) {
        //     n = a.length; this.k = k; this.a = a; 
        //     m = new HashMap<String, Integer>();
        //     int x = dfs(1l, 1l, 0l, 0l);
        //     int y = dfs(1l, 1l, 0l, 1l);
        //     int z = dfs(1l, 1l, 0l, 2l);
        //     return x + y + z;
        // }
        ...
        // long k;
        // // 【分子、分母、 idx=i, [012]j 】
        // int dfs(long f, long g, long i, long j) {
        //     String key = String.valueOf(f) + "-" + String.valueOf(g) + "-" + i + "-" + j;
        //     if (m.containsKey(key)) return m.get(key);
        //     int r = 0;
        //     if (i == n-1) {
        //         if (j == 0l) 
        //             r = (f * (long)a[(int)i] == k * g ? 1 : 0);
        //         else if (j == 1l)
        //             r = (f == k * g * (long)a[(int)i] ? 1 : 0);
        //         else if (j == 2l)
        //             r = (f == k * g ? 1 : 0);
        //         m.put(key, r);
        //         return r;
        ...
        //     for (int x = 0; x < 3; x++) {
        //         if (j == 0l) 
        //             r = r + dfs(f * (long)a[(int)i], g, i+1, x);
        //         else if (j == 1l)
        //             r = r + dfs(f, g * (long)a[(int)i], i+1, x);
        //         else if (j == 2l)
        //             r = r + dfs(f, g, i+1, x);
        //     }
        //     m.put(key, r);
    ...
    public static void main (String[] args) { 
        ...
        // int [] a = new int [] {4, 6, 3};
        int [] a = new int [] {4,5,6,3,4,5,6,3,4,5,6,3,4,5,6,3,4,5,6};

        int r = s.countSequences(a, 1);
