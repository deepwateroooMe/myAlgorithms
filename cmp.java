...
//         }
        ...
        // 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
        // Leetcode 的它们的贱鸡、贱畜牲们，真贱！！！
        public String[] largestString(int[] a) {
            int n = a.length;
            // int i = (int)Math.pow(2, 25), j = (int)Math.pow(2, 27);
        ...
        String toLargestString(int v) {
            ...
            System.out.println("((int)Math.pow(2, d) == v): " + ((int)Math.pow(2, d) == v));
            if (d < 25) {
    ...
    public static void main (String[] args) { 
        ...
        int [] a = new int [] {927, 617};

        String []  r = s.largestString(a);
