...
- missing ranges
- two sum II
- get Emacs JDEE environment ready, can compile and run inside emacs now, very convenient;
- one edit distance
- *DONT LIKE:*  read n characters given read4 II
* 12/31/2014, Wednesday
- java-mode autofill and snippets , tab-indent are all working now;
- worked on *10* problems, *19/173*: 
- Longest substring with at most 2 distinct characters, took my effort to rewrite it;
