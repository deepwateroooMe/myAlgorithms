...
**** 怎么才能把问题分析透彻，看清问题考查的本质
     
[[./pic/graph_20230412_083249.png]]
   #+BEGIN_SRC java
...
回到节点 uu 之后，我们得到了一条从 uu 开始到 uu 结束的回路，这条回路上仍然有些节点有未经过的出边。我么从某个这样的节点 vv 开始，继续得到一条从 vv 开始到 vv 结束的回路，再嵌入之前的回路中，即 u->...->v->...->u 变为 u->...->v->...->v->...->u
...
#+END_SRC 
*** 2258. Escape the Spreading Fire: 多源头 BFS
