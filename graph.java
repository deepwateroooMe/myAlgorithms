...
public class graph {
    public static class Solution {
        ...
        //         m.get(red_edges[i][0]).add(red_edges[i][1]);
        //         s.add(red_edges[i][0]);
        //     }
        //     for (int i = 0; i < blue_edges.length; i++) {
        //         o.get(blue_edges[i][0]).add(blue_edges[i][1]);
        ...
        //     // for (Map.Entry<Integer, List<Integer>> entry : o.entrySet()) {
        //     //     System.out.print(entry.getKey() + ": "); 
        //     //     for (int z = 0; z < entry.getValue().size(); z++) 
        //     //         System.out.print(entry.getValue().get(z) + ", ");
        //     //     System.out.print("\n");
        ...
        //     return res;
        // }
        // private void dfs(int t, int i, boolean cur, int cnt) {
        //     // System.out.println("i: " + i);
        //     // System.out.println("cur: " + cur);
        //     // System.out.println("cnt: " + cnt);
        //     if ((cur && m.get(i).size() == 0) || (!cur && o.get(i).size() == 0)) {
        //         return;
        //     }
        //     if (cnt + 1 >= max) return;
        //     if (cur) {
