...
//         int r = s.findGoodStrings(8, a, b, c);
        ...
        // public int minimumDistance(String t) { // 1320
        ...
        // public int minimumTime(int n, int[][] egs, int [] t) { // 2050
        //     int [] p = new int [n];
        //     for (int [] e : egs) {
        //         int u = e[0], v = e[1];
        ...
        //         for (int toBeSelected = r; toBeSelected > 0; toBeSelected = toBeSelected & (toBeSelected-1)) { // 遍历候选课程所有可能的状态
        ...
        // // int r = s.minimumTime(9, a, b); // 没弄明白，这里为什么错了。。
